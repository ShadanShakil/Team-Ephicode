  ...
  return (
    <section className="py-10 md:py-16 lg:py-20 px-5 md:px-10 lg:px-16" id="about" ref={ref}>
      <div className="max-w-[1400px] mx-auto">
        <div
          className={`bg-card border border-border/60 rounded-2xl md:rounded-3xl p-7 md:p-10 lg:p-14 flex flex-col md:flex-row md:items-center md:justify-between gap-7 transition-all duration-700 ease-out ${
